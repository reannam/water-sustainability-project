...
const fetchAffectedAreas = async (postcode: string) => {
  ...
  const mockAreas = ["City Center", "Riverside", "Oakwood", "Hillside", "Meadowlands"]

  // Randomly select 2-4 areas
  return mockAreas.sort(() => 0.5 - Math.random()).slice(0, Math.floor(Math.random() * 3) + 2)
}
  ...
  return (
    <div className="container mx-auto p-4">
      <Card className="w-full max-w-md mx-auto">
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">Near Me</CardTitle>
        </CardHeader>
        <CardContent>
          ...
          {affectedAreas.length > 0 && (
            <div className="mt-6">
              <h2 className="text-lg font-semibold mb-2">Affected Areas Near {postcode}:</h2>
